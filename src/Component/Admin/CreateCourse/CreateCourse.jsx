...
<Input  id='description' value={description} onChange={(e)=>setDescription(e.target.value)} placeholder='description...' type={'text'} focusBorderColor={'purple.300'}/>
<Input id='name' value={createdBy} onChange={(e)=>setCreatedBy(e.target.value)} placeholder='Creator Name By' type={'text'} focusBorderColor={'purple.300'}/>
   ...
   <Input accept='image/*' required  type={'file'} focusBorderColor={'purple.500'} css={{"&::file-selector-button":{
